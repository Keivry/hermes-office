ARG HERMES_AGENT_VERSION=v2026.8.19
...
# As of v2026.8.19: 009/010 (empty tool_calls dedup + wire boundary), 012
...
#         in the last 14 days (e.g. docling 2.121.0). Run from /tmp to bypass.
RUN cd /tmp \
