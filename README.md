...
- Current pinned version in `Dockerfile`: `v1.0.106`
...
- Current pinned version in `Dockerfile`: `v2.9.0`
...
- **RTK binary** at `/usr/local/bin/rtk` — pinned to `v0.42.2` (musl static binary)
